...
#*
#*
#*			USAGE: $ python bf_kp_match.py -c1 card1.png -c2 card2.png -d deck
#*
#*			
#************************************************************************
...
img4 = cv2.drawMatchesKnn(img1,bestkp1,bestImage,bestkp2,best,None,flags=2)
...
bestImage = cv2.imread(bestImg)
img5 = cv2.drawMatchesKnn(img2,bestkp1,bestImage,bestkp2,best,None,flags=2)
